...
export const TAB_GROUPS: Record<SettingTab, readonly string[]> = {
	...
	context: ["General", "Compaction", "Rules (TTSR)", "Second Thought", "Experimental"],
...
export const SECOND_THOUGHT_ATOMS = ["check", "rehearse", "recall", "alternative"] as const;
const DEFAULT_SECOND_THOUGHT_ATOMS: SecondThoughtAtom[] = [...SECOND_THOUGHT_ATOMS];
...
export const SETTINGS_SCHEMA = {
	...
	"secondThought.branchCount": {
		...
		ui: {
			...
			group: "Second Thought",
			label: "Branch Count",
			description: "Background reflection calls per tool batch.",
			options: [
	...
	"secondThought.branchMaxTokens": {
		...
		ui: {
			tab: "context",
			group: "Second Thought",
			label: "Branch Max Tokens",
			description: "Maximum tokens generated by each background reflection call.",
		},
	},

	"secondThought.harvestCapPerAtom": {
		type: "number",
		default: 20,
		ui: {
			tab: "context",
			group: "Second Thought",
			label: "Harvest Cap Per Atom",
			description: "Maximum complete reflection units retained for each atom.",
		},
	},

	"secondThought.atoms": {
		type: "array",
		default: DEFAULT_SECOND_THOUGHT_ATOMS,
		ui: {
			tab: "context",
			group: "Second Thought",
			label: "Reflection Atoms",
			description: "Reflection prompts to include in each background branch.",
			options: SECOND_THOUGHT_ATOMS.map(value => ({ value, label: value })),
		},
	},

	"secondThought.maxContextTokens": {
		type: "number",
		default: 100_000,
		ui: {
			tab: "context",
			...
			description: "Skip background reflections when the estimated context exceeds this size.",
		},
	},

	"secondThought.minConditioningChars": {
		type: "number",
		default: 64,
		ui: {
			tab: "context",
			group: "Second Thought",
			label: "Minimum Conditioning Characters",
			description: "Skip reflections when too little model thinking is available to condition them.",
		},
	},

	"secondThought.deliveryCalls": {
		type: "number",
		default: 1,
		ui: {
			tab: "context",
			...
			description: "Number of following model calls that receive harvested reflections.",
		},
	},

	"secondThought.showInTranscript": {
		type: "boolean",
		default: false,
		ui: {
			tab: "context",
			group: "Second Thought",
			label: "Show In Transcript",
			description: "Show Second Thought diagnostic entries in the transcript.",
		},
	},
...
export interface SecondThoughtSettings {
	...
	harvestCapPerAtom: number;
	atoms: SecondThoughtAtom[];
	maxContextTokens: number;
	minConditioningChars: number;
