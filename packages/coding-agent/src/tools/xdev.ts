 ...
 * makes it unreachable in practice (issue #5973). `canvas` owns a
 * session-specific artifact and must not be addressed through the shared
 * `xd://canvas` device name — each loses its harness integration or usability
 * if hidden behind dispatch.
 */
